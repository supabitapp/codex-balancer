...
- Draining turns use the fast service tier when the account's model catalog allows it. The account reaches zero sooner and the pool returns to normal balancing.
