...
// Open opens a log using the server's bounded retention policy.
func Open(path string, now func() time.Time) (*rotatingLog, error) {
	return open(path, logPolicy{
...
func open(path string, policy logPolicy, now func() time.Time) (*rotatingLog, error) {
